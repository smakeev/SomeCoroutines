...
public extension SG where Type: Numeric & Comparable {
	...
	static func range(_ target: Type, additional: ((Type, Any) -> Type)? = nil) -> SG<Type> {
	...
	static func range(_ target: Type, step: Type, additional: ((Type, Any) -> Type)? = nil) -> SG<Type> {
		let SELF = SG<Type>()
	...
	static func range(_ begin: Type?, _ target: Type, _ step: Type? = nil, additional: ((Type, Any) -> Type)? = nil) -> SG<Type> {
		let SELF = SG<Type>()
